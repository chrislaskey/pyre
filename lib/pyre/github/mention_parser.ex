defmodule Pyre.GitHub.MentionParser do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Pyre.GitHub.MentionParser.parse("@pyre-review review", "pyre-review")
      {:ok, {:review, []}}

      iex> Pyre.GitHub.MentionParser.parse("@pyre-review explain the auth changes", "pyre-review")
      {:ok, {:explain, [args: "the auth changes"]}}

      iex> Pyre.GitHub.MentionParser.parse("@pyre-review what about error handling?", "pyre-review")
      {:ok, {:followup, "what about error handling?"}}

      iex> Pyre.GitHub.MentionParser.parse("no mention here", "pyre-review")
      :ignore

      iex> Pyre.GitHub.MentionParser.parse("```\\n@pyre-review review\\n```", "pyre-review")
      :ignore
